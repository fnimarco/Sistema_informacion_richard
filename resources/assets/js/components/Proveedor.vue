                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" v-model="telefono_contacto" class="form-control" placeholder="Teléfono del contacto" min="1" max="8">
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods : {
            ...
            validarPersona(){
                ...
                //if (!this.telefono_contacto) this.errorMostrarMsjPersona.push("El telefono de contacto debe contener 8 digitos");
